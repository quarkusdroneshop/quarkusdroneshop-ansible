...
curl -OL https://raw.githubusercontent.com/nmushino/quarkuscoffeeshop-ansible/refs/heads/master/files/sample_mongo_data.json \
  && mkdir -p /data/  \
  && mv sample_mongo_data.json /data/

curl -OL https://raw.githubusercontent.com/nmushino/quarkuscoffeeshop-ansible/refs/heads/master/files/load_database.sh \
  && chmod +x load_database.sh && mv load_database.sh /bin/load_database

curl -OL https://raw.githubusercontent.com/nmushino/quarkuscoffeeshop-ansible/refs/heads/master/files/configure_mongodb_user.sh \
