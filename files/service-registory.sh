...
curl -X POST \
  http://droneshop-apicurioregistry-kafkasql.quarkusdroneshop-demo.router-default.apps.${CLUSTER_DOMAIN_NAME}/apis/ccompat/v7/subjects/kitchen-in/versions \
  -H "Content-Type: application/vnd.schemaregistry.v1+json" \
  -d '{
    "schema": "{\"type\":\"record\",\"name\":\"kitchen_in\",\"namespace\":\"quarkusdroneshop_demo\",\"fields\":[{\"name\":\"orderId\",\"type\":\"string\"},{\"name\":\"lineItemId\",\"type\":\"string\"},{\"name\":\"item\",\"type\":\"string\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"timestamp\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}}]}",
    "schemaType": "AVRO"
  }'
sleep 5

curl -X POST \
  http://droneshop-apicurioregistry-kafkasql.quarkusdroneshop-demo.router-default.apps.${CLUSTER_DOMAIN_NAME}/apis/ccompat/v7/subjects/barista-in/versions \
  -H "Content-Type: application/vnd.schemaregistry.v1+json" \
  -d '{
    "schema": "{\"type\":\"record\",\"name\":\"barista_in\",\"namespace\":\"quarkusdroneshop_demo\",\"fields\":[{\"name\":\"orderId\",\"type\":\"string\"},{\"name\":\"lineItemId\",\"type\":\"string\"},{\"name\":\"item\",\"type\":\"string\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"timestamp\",\"type\":\"string\"}]}",
    "schemaType": "AVRO"
  }'
sleep 5
