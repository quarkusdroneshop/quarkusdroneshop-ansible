...
skupper_deploy() {
    ...
    if [ "$SITE_CONFREM" = "A" ]; then
        ...
        skupper connector create external-shop-cluster-kafka-asite 9094 --selector strimzi.io/broker-role=true -n "$NAMESPACE"
        ...
        skupper connector create external-shop-cluster-kafka-bsite 9094 --selector strimzi.io/broker-role=true -n "$NAMESPACE"
        ...
        skupper connector create external-shop-cluster-kafka-csite 9094 --selector strimzi.io/broker-role=true -n "$NAMESPACE"
        skupper listener create external-shop-cluster-kafka-asite 9094 -n "$NAMESPACE"
        skupper listener create external-shop-cluster-kafka-bsite 9094 -n "$NAMESPACE"
